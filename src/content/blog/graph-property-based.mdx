...
tags: nx, monorepo, monads, state monad, newtypes, fp, functional programming, typescript, event sourcing
description: Discover the crucial role of deterministic code in property-based tests! Unveil how the state monad enhances code structure for robust, reliable outcomes. Explore this and more in our exploration of isomorphic web apps and coding patterns in Typescript.
publication-date: 04/12/2023
opengraphImage: /static/blog/graph-property-based/goctopus.png
reading-time: 24
author: Igor Loskutov
company-title: Count Graphula
social-media-handle: Firfi
social-media-url: https://github.com/Firfi
author-image: /static/core/img/img-team-037.png
repo: https://github.com/Firfi/graphgen-ts
published: 2024-05-10T13:44:27Z
---
...
Going <font color="yellow" style="background-color: black">functional</font> is not necessary here, and we can achieve determinism without it, but with PRNGs, it turned out to be a very convenient way to organize computation.
...
This is one of the examples of monadical computations in my graph generator, where monads help with keeping code concise and focusing on “what” I want to achieve, not “how”. Here it helps specifically with passing the immutable RNG state, which I need for the computation to stay deterministic but still reasonably random. Without it, I’d have to pass this state manually.
