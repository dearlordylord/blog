...
You put a Zod[^zod] schema at your API boundary. Same instinct, different layer. You're not checking logic. You're checking shape. Right structure, right types, values within range. The parser runs once, at the edge, and everything downstream trusts the output. It's a gate, not a monitor.
