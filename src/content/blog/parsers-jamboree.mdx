...
> It also means that being able to “transform” outside world types into domain/language types is expected, although lacking this ability doesn’t justify disqualification.
>
> The most obvious example is when, through JSON, we receive an array of items that are supposed to be unique, e.g., the user’s favourite colours: we don’t tolerate when the user has favourited “pink” three times! In Javascript, this assumption naturally translates into the Set data structure, which the validator (
...
graph TD
   ...
   subgraph Properties
       direction TB
       A --> B1[name: non-empty string]
       A --> B2[email: quasi-valid email]
       A --> B3[createdAt: ISO date string]
       A --> B4[updatedAt: ISO date string, not before createdAt]
       A --> B5[subscription: FREE, PRO, PREMIUM]
       A --> B6[stripeId: starts with cus_]
       A --> B7[visits: non-negative integer]
       A --> B8[favouriteColours: red, green, blue, or #NNNNNN, no duplicates]
       A --> B9[profile]
       A --> B10[fileSystem]
   end
   ...
   subgraph Profile
       direction TB
       B9 --> C1[type: listener]
       C1 --> D1[boughtTracks: non-negative integer]
       B9 --> C2[type: artist]
       C2 --> D2[publishedTracks: non-negative integer]
   end


   subgraph FileSystem
       direction TB
       B10 --> E1[type: directory]
       E1 --> F1[name: string]
       E1 --> F2[children: array of file or directory]

       F2 --> G1[type: directory]
       G1 --> H1[name: string]
       G1 --> H2[children: fileSystem]
...
![Inferno by Botticelli](https://loskutoff.com/static/blog/parsers-jamboree/infer-botticelli.jpg "Inferno")
...
![DSquared by Google](https://loskutoff.com/static/blog/parsers-jamboree/dsquared.png "Dsquared")
...
> I’m convicted that defining types one extra time isn’t a big deal, though, as long as the type system doesn’t allow for lies like `object({ n: integer() }; type O = {s: string}`. You’ll see that in some cases, we’ll have to write extra type definitions, notably for recursive structures, to help Typescript inver and not fall into infinite recursion.
...
![Inputs](https://loskutoff.com/static/blog/parsers-jamboree/inputs.png "https://bijijoo.com/2011/leonid-brezhnev")
...
![Outputs](https://loskutoff.com/static/blog/parsers-jamboree/outputs.png "https://bijijoo.com/2011/leonid-brezhnev")
...
![Lego Bricks](https://loskutoff.com/static/blog/parsers-jamboree/bricks.png  "https://openclipart.org/detail/184889/bricks")
...
![Frontend](https://loskutoff.com/static/blog/parsers-jamboree/frontend.png "https://bijijoo.com/2011/leonid-brezhnev")
...
![Interface](https://loskutoff.com/static/blog/parsers-jamboree/interface.png "Interface")
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/ajv" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/arktype" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/decoders" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/effect-schema" height="500"></iframe>
...
RESCRIPT IFRAME HERE [https://parsers-jamboree.apps.loskutoff.com/rescript-schema ](https://parsers-jamboree.apps.loskutoff.com/rescript-schema)
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/runtypes" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/schemata-ts" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/superstruct" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/typebox" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/valibot" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/valita" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/yup" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/zod" height="500"></iframe>
...
<iframe src="https://parsers-jamboree.apps.loskutoff.com/summary?iframe" height="630px"></iframe>
